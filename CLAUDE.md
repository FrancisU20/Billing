...
| `context/CERTIFICATES.md`  | Movil nativo, ampliacion de CAs y costo a escala son decisiones futuras. Auditoria 2026-06-27: prefix de secret duplicado entre codigo e infra CDK (ver `BACKEND.md`). Solventado 2026-06-29: logs de Secrets Manager en `CertificateStore` incluyen detalle de excepcion sin exponer p12/password                                                                                                                                                                                                                  |

...
| `context/CERTIFICATES.md`  | Movil nativo, ampliacion de CAs y costo a escala son decisiones futuras. Auditoria 2026-06-27 (nueva seccion): log de error de Secrets Manager sin detalle de la excepcion; prefix de secret duplicado entre codigo e infra CDK (ver `BACKEND.md`)                                                                                                                                                                                                                  |

...
_PLANS: list[dict] = [
    dict(
        ...
        monthly_price=Decimal("0.00"), annual_price=Decimal("0.00"),
        document_limit=20, limit_cycle="year",
        max_locations=1, max_emission_points=1, max_users=1,
        includes_credit_notes=False, includes_withholdings=False,
        includes_delivery_notes=False, includes_api=False, order=0,
    ),
    dict(
        ...
        includes_delivery_notes=True, includes_api=False, order=1,
    ),
    dict(
        slug="pyme", name="Pyme",
        description="Para pymes en crecimiento con varios locales.",
        monthly_price=Decimal("14.99"), annual_price=Decimal("143.00"),
    ...
    dict(
        slug="pro", name="Profesional",
        description="Para empresas con integración contable y multi-establecimiento.",
        monthly_price=Decimal("29.99"), annual_price=Decimal("287.00"),
        document_limit=1000, limit_cycle="month",
        max_locations=-1, max_emission_points=-1, max_users=10,
        includes_credit_notes=True, includes_withholdings=True,
        includes_delivery_notes=True, includes_api=True, order=3,
    ),
    dict(
        slug="enterprise", name="Empresarial",
        description="Para distribuidoras y cadenas con alto volumen.",
        monthly_price=Decimal("59.99"), annual_price=Decimal("575.00"),
        document_limit=-1, limit_cycle="month",
        max_locations=-1, max_emission_points=-1, max_users=-1,
        includes_credit_notes=True, includes_withholdings=True,
        includes_delivery_notes=True, includes_api=True, order=4,
    ),
]

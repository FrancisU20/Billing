    ...
    try {
      ...
      if (result.type === 'challenge') {
        router.push({
          ...
          params: { session: result.challenge.session, challenge_name: result.challenge.challenge_name },
        })
        return
      }
  ...
  return (
    <View style={[staticStyles.page, { backgroundColor: pageBg }]}>
      <View style={staticStyles.content}>
        ...
        >
          <Text style={[staticStyles.pricingText, { color: pricingColor }]}>Ver planes de precios</Text>
...
const staticStyles = StyleSheet.create({
  ...
  title: { fontSize: typography.size['4xl'], fontWeight: typography.weight.bold, letterSpacing: -1, lineHeight: typography.size['4xl'] * 1.1 },
